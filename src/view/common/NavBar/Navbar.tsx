    ...
    return (
        <div className="p-2 bg-[#444544] flex justify-between">
            <div className="flex p-2">
                <h1 className="text-3xl text-[#e6f0e6] hover:text-green-400">Organic Shop</h1>
            ...
            {username ? (
                ...
                <Link to="/login" className="text-[1.5rem] text-[#e6f0e6] bg-[#1f9e4b] py-3 px-6 rounded-lg border-white border-2 hover:bg-green-400">
                    Sign In
                </Link>
            )}
        </div>
